...
js = js.replace(/receiveBtQrFirebase\(\{([\s\S]*?)\}\)/g, 'receiveBtQrFirebase({ \, bt: Number(new URLSearchParams(window.location.search).get(\"bt\")), nonce: new URLSearchParams(window.location.search).get(\"nonce\") })');

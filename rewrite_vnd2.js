...
content = content.substring(0, s2) + `async function payMerchantFirebase(uid, merchantId, amountVnd, { currency = 'VND', amountKrw, reqId } = {}) {
  ...
  return await db.runTransaction(async (tx) => {
    ...
    const [ownerSnap] = await tx.get(merchantOwnerRef);
...
console.log('Fixed syntax error in transaction.js');

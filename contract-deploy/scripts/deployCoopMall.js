...
async function main() {
  ...
  // ── 생성자 인자 ──────────────────────────────────────
  const HEX_TOKEN  = '0x41F2Ea9F4eF7c4E35ba1a8438fC80937eD4E5464'; // HEX 플랫폼 포인트 토큰 (18 decimals)
  const JUMP_TOKEN = '0xA3C35c52446C133b7211A743c6D47470D1385601'; // JUMP 거래 토큰 (0 decimals)
  ...
  console.log('\nCoopMall v4 배포 중...');
  const contract = await Factory.deploy(HEX_TOKEN, JUMP_TOKEN, JUMP_BANK);
  ...
  console.log('  3. 관리자 지갑에서 JUMP 토큰 충전 (joinMall JUMP 지급용)');
}

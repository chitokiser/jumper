...
## 5) 게임목적
이게임은 보물지도를 이용하여 운영자와 유저들이 숨겨놓은 보물을 찾고 /몬스터를 잡고/ 유저가 직접 상점을 개설하여 
게임코인울 벌어야 한다. 게임코인은 jump토큰과 교환할 수 있다.

Jump 토큰을 보유하고 있으면 jumpdao의 주주로 인정한다.
Jump토큰 보유량에 비례하여 특별혜택을 받을 수 있다.
jump 토큰 보유량과 비례하여 플랫폼 수익을  매주 배당 받을 수 있다.
jumpDAO 플랫폼 수익(가맹점수수료,회비,jump토큰 매도 수수료,배너광고 수익등)
회비를 포함한 모든 jumpDAO의 결제는 HEX토큰으로 가능하다.
HEX는 https://hexdao.netlify.app/ 에서 
1HEX = 1USDT 비율로 교환된다.
...
export const SPRITE_CONFIGS = {
  ...
  orc: {
    ...
    facingLeft:  false,
    animations: {
      idle:    { prefix: 'ORK_01_IDLE_',   frames: 6, fps: 8,  loop: true  },
      walk:    { prefix: 'ORK_01_WALK_',   frames: 6, fps: 10, loop: true  },
      attack:  { prefix: 'ORK_01_ATTAK_',  frames: 6, fps: 12, loop: false },
      hit:     { prefix: 'ORK_01_HURT_',   frames: 6, fps: 12, loop: false },
      death:   { prefix: 'ORK_01_DIE_',    frames: 6, fps: 8,  loop: false },
      respawn: { prefix: 'ORK_01_IDLE_',   frames: 6, fps: 6,  loop: false },
    },
  },
  pirate: {
    monsterType: 'pirate',
    ...
    facingLeft:  false,
    animations: {
      idle:    { prefix: '1_entity_000_IDLE_',   frames: 6, fps: 7,  loop: true  },
      walk:    { prefix: '1_entity_000_WALK_',   frames: 6, fps: 8,  loop: true  },
      attack:  { prefix: '1_entity_000_ATTACK_', frames: 6, fps: 12, loop: false },
      hit:     { prefix: '1_entity_000_HURT_',   frames: 6, fps: 12, loop: false },
      death:   { prefix: '1_entity_000_DIE_',    frames: 6, fps: 8,  loop: false },
      respawn: { prefix: '1_entity_000_IDLE_',   frames: 6, fps: 6,  loop: false },
    },
  },
  orc2: {
    monsterType: 'orc2',
    ...
    facingLeft:  false,
    animations: {
      idle:    { prefix: 'ORK_02_IDLE_',   frames: 6, fps: 8,  loop: true  },
      walk:    { prefix: 'ORK_02_WALK_',   frames: 6, fps: 10, loop: true  },
      attack:  { prefix: 'ORK_02_ATTAK_',  frames: 6, fps: 12, loop: false },
      hit:     { prefix: 'ORK_02_HURT_',   frames: 6, fps: 12, loop: false },
      death:   { prefix: 'ORK_02_DIE_',    frames: 6, fps: 8,  loop: false },
      respawn: { prefix: 'ORK_02_IDLE_',   frames: 6, fps: 6,  loop: false },
    },
  },
  orc3: {
    monsterType: 'orc3',
    ...
    facingLeft:  false,
    animations: {
      idle:    { prefix: 'ORK_03_IDLE_',   frames: 6, fps: 8,  loop: true  },
      walk:    { prefix: 'ORK_03_WALK_',   frames: 6, fps: 10, loop: true  },
      attack:  { prefix: 'ORK_03_ATTAK_',  frames: 6, fps: 12, loop: false },
      hit:     { prefix: 'ORK_03_HURT_',   frames: 6, fps: 12, loop: false },
      death:   { prefix: 'ORK_03_DIE_',    frames: 6, fps: 8,  loop: false },
      respawn: { prefix: 'ORK_03_IDLE_',   frames: 6, fps: 6,  loop: false },
    },
  },
  pirate2: {
    monsterType: 'pirate2',
    ...
    facingLeft:  false,
    animations: {
      idle:    { prefix: '2_entity_000_IDLE_',   frames: 6, fps: 7,  loop: true  },
      walk:    { prefix: '2_entity_000_WALK_',   frames: 6, fps: 8,  loop: true  },
      attack:  { prefix: '2_entity_000_ATTACK_', frames: 6, fps: 12, loop: false },
      hit:     { prefix: '2_entity_000_HURT_',   frames: 6, fps: 12, loop: false },
      death:   { prefix: '2_entity_000_DIE_',    frames: 6, fps: 8,  loop: false },
      respawn: { prefix: '2_entity_000_IDLE_',   frames: 6, fps: 6,  loop: false },
    },
  },
  pirate3: {
    monsterType: 'pirate3',
    ...
    facingLeft:  false,
    animations: {
      idle:    { prefix: '3_3-PIRATE_IDLE_',   frames: 6, fps: 7,  loop: true  },
      walk:    { prefix: '3_3-PIRATE_WALK_',   frames: 6, fps: 8,  loop: true  },
      attack:  { prefix: '3_3-PIRATE_ATTACK_', frames: 6, fps: 12, loop: false },
      hit:     { prefix: '3_3-PIRATE_HURT_',   frames: 6, fps: 12, loop: false },
      death:   { prefix: '3_3-PIRATE_DIE_',    frames: 6, fps: 8,  loop: false },

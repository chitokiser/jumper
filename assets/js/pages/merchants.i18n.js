...
const MESSAGES = {
  ...
  gs_idle:               { en: 'Connect to game server',   ko: '게임 서버 연결',           vi: 'Kết nối máy chủ' },
  ...
  tut_step2_title:       { en: '👾 Enable server monsters', ko: '👾 서버 몬스터 켜기',       vi: '👾 Bật quái vật máy chủ' },
  tut_step2_body:        { en: 'Tap ▶ to connect to the game server.\nMonsters will appear on the map after connecting.\nTap a monster to attack!',

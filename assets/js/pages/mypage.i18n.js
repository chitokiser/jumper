...
const MESSAGES = {
  ...
  label_point:             { ko: '포인트(hex로 변경가능)', en: 'Points (→Point)', vi: 'Điểm (→Point)' },
  btn_redeem:              { ko: 'Point로 전환', en: 'Convert to Point', vi: 'Chuyển sang Point' },
  label_my_mentor:         { ko: '나의 멘토', en: 'My Mentor', vi: 'Người hướng dẫn' },
  label_hex_balance:       { ko: '보유 Point', en: 'Point Balance', vi: 'Số dư Point' },
  ...
  // ── Point 이체 ───────────────────────────────────────────────────────────────
  section_hex_transfer:    { ko: 'Point 개인 지갑 이체', en: 'Point Transfer to Personal Wallet', vi: 'Chuyển Point ra ví cá nhân' },
  label_to_wallet:         { ko: '수령 지갑 주소', en: 'Recipient Address', vi: 'Địa chỉ nhận' },
  label_transfer_amt:      { ko: '이체 수량 (Point)', en: 'Transfer Amount (Point)', vi: 'Số lượng chuyển (Point)' },
  ...
  // ── Point 충전 ───────────────────────────────────────────────────────────────
  section_deposit:         { ko: 'Point 충전 (원화)', en: 'Point Top-up (Fiat)', vi: 'Nạp Point (tiền mặt)' },
  ...
  deposit_warn:            { ko: '입금자명을 정확히 입력하세요. 관리자 확인 후 Point 포인트이 수탁 지갑으로 지급됩니다.', en: 'Enter the depositor name accurately. Point will be credited after admin confirmation.', vi: 'Nhập chính xác tên người nạp. Point sẽ được cộng sau khi admin xác nhận.' },
  ...
  mi_stat_total_hex:       { ko: '총 결제액 Point', en: 'Total Payment Point', vi: 'Tổng Point thanh toán' },
  ...
  mi_tx_row:               { ko: '결제 {0} Point → 내 수익 {1} Point', en: 'Payment {0} Point → My earnings {1} Point', vi: 'Thanh toán {0} Point → Thu nhập {1} Point' },
  ...
  jackpot_stat_redeemable: { ko: 'Point 전환 가능 포인트', en: 'Redeemable Points (Point)', vi: 'Điểm có thể đổi Point' },
  jackpot_stat_min:        { ko: '10 Point 이상 시 전환 가능', en: 'Min 10 Point to convert', vi: 'Tối thiểu 10 Point để chuyển đổi' },
  ...
  jp_pts_label:            { ko: '포인트', en: 'Point pts', vi: 'điểm Point' },
  ...
  jm_onchain_desc:         { ko: '온체인 복권 당첨! {0} 포인트 적립', en: 'On-chain lottery win! +{0} Points', vi: 'Trúng xổ số on-chain! +{0} Point điểm' },
  ...
  voucher_price:           { ko: '가격: {0} Point', en: 'Price: {0} Point', vi: 'Giá: {0} Point' },
  voucher_refund:          { ko: '소각 환급: {0} Point', en: 'Burn refund: {0} Point', vi: 'Hoàn đốt: {0} Point' },
  ...
  burn_game_note:          { ko: '게임 바우처는 Point 환급이 없습니다.', en: 'Game vouchers have no Point refund.', vi: 'Voucher game không hoàn lại Point.' },
  burn_info:               { ko: '{0}을(를) 소각하면 <strong>{1} Point</strong>{2}를 환급받고 <strong>{3} Point</strong>는 수수료로 차감됩니다.', en: 'Burning {0} refunds <strong>{1} Point</strong>{2} and deducts <strong>{3} Point</strong> as fee.', vi: 'Đốt {0} hoàn <strong>{1} Point</strong>{2} và trừ <strong>{3} Point</strong> phí.' },
  burn_game_info:          { ko: '<strong>{0}</strong>을(를) 소각합니다.<br><span style="color:#9ca3af;font-size:0.85em;">게임 바우처는 Point 환급이 없습니다.</span>', en: 'Burning <strong>{0}</strong>.<br><span style="color:#9ca3af;font-size:0.85em;">Game vouchers have no Point refund.</span>', vi: 'Đốt <strong>{0}</strong>.<br><span style="color:#9ca3af;font-size:0.85em;">Voucher game không hoàn lại Point.</span>' },
  ...
  burn_step3_onchain:      { ko: 'Point 환급 처리 중', en: 'Processing Point refund', vi: 'Đang xử lý hoàn Point' },
  ...
  burn_done_onchain:       { ko: '✅ 소각 완료! Point가 지갑으로 전송되었습니다.', en: '✅ Burned! Point sent to wallet.', vi: '✅ Đã đốt! Point đã gửi vào ví.' },
  ...
  redeem_not_enough:       { ko: '포인트가 부족합니다. 10 Point 이상 적립 후 전환할 수 있습니다.\n현재: {0} Point', en: 'Insufficient points. Need at least 10 Point.\nCurrent: {0} Point', vi: 'Không đủ điểm. Cần ít nhất 10 Point.\nHiện tại: {0} Point' },
  redeem_confirm:          { ko: '포인트를 Point로 전환하시겠습니까?', en: 'Convert points to Point?', vi: 'Chuyển điểm sang Point?' },
  ...
  redeem_done:             { ko: 'Point 전환이 완료되었습니다.', en: 'Point conversion complete.', vi: 'Đã chuyển đổi Point xong.' },
  redeem_error:            { ko: '전환 실패: {0}', en: 'Conversion failed: {0}', vi: 'Chuyển thất bại: {0}' },
  redeem_btn:              { ko: 'Point로 전환', en: 'Convert to Point', vi: 'Chuyển sang Point' },

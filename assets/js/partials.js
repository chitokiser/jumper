...
const _HDR_T = {
  vi: {
    ...
    hdr_benefits: 'Quyền lợi Jump', hdr_limousine: 'Jump Limousine', hdr_dao: 'Biểu quyết DAO', hdr_monster_race: '🛹 Monster Race',
  ...
  en: {
    ...
    hdr_benefits: 'Jump Benefits', hdr_limousine: 'Jump Limousine', hdr_dao: 'DAO Vote', hdr_monster_race: '🛹 Monster Race',
  ...
  ko: {
    ...
    hdr_benefits: 'Jump혜택', hdr_limousine: '점프리무진', hdr_dao: 'DAO 의결', hdr_monster_race: '🛹 몬스터 레이스',
